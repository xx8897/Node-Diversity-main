...
def compute_neighbor_attribute(G, node_attr, specified_attr=NODE_NEIGHBOR_DEGREE):
    ...
    for ni in G:
        ...
        if specified_attr == NODE_CC:
            if len(neighbor_list) == 0: # case 1: neighbor's cc = 0
                neighbor_attr[ni] = 0
        ...
        elif specified_attr == NODE_NEIGHBOR_DEGREE:
            neighbor_attr_list = [node_attr[n] for n in neighbor_list]
...
def main_function():
    ...
    file_name       = 'facebook_gcc'       # N=1222,   E=16714,   MAX_CORE=36
